...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name_k', models.CharField(max_length=20)),
                ('location', models.CharField(max_length=100)),
                ('loc_x', models.FloatField()),
                ('loc_y', models.FloatField()),
                ('restaurants', models.ManyToManyField(related_name='nearby_schools', to='app1.Restaurant')),
            ],
        ),
        migrations.CreateModel(
            name='Review',
        ...
        migrations.AddField(
            model_name='user',
            name='school',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='students', to='app1.school'),
        ),
        migrations.AddField(
            model_name='user',
